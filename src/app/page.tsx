      ...
      <main className="flex-1 w-full pt-32 overflow-hidden">
        ...
        <section id="work" className="bg-zinc-50 dark:bg-zinc-950 py-40 border-y border-zinc-100 dark:border-zinc-900 overflow-hidden" aria-labelledby="work-heading">
          <div className="max-w-7xl mx-auto px-6">
            <ScrollReveal className="flex flex-col md:flex-row items-baseline justify-between mb-20 gap-8">
            ...
            <ScrollReveal delay={200} className="relative group overflow-hidden rounded-[2.5rem] bg-white/60 dark:bg-white/5 backdrop-blur-xl border border-white/20 dark:border-white/10 aspect-[16/9] md:aspect-[21/9] shadow-2xl shadow-black/10 dark:shadow-black/40">
          ...
          <ScrollReveal delay={200} className="grid md:grid-cols-3 gap-6">
            {services.map((service) => (
              <CardSpotlight
                ...
                className="group rounded-[2rem] border border-zinc-100 dark:border-zinc-800/60 bg-zinc-50 dark:bg-zinc-950 p-10 transition-all hover:border-zinc-300 dark:hover:border-zinc-700 hover:shadow-xl hover:shadow-black/5 dark:hover:shadow-black/30"
              >
