  ...
  return (
    <div className="relative w-full overflow-hidden">
      ...
      <div className="absolute inset-0 pointer-events-none" style={{ zIndex: 0 }}>
        <LinesGradientShader className="absolute inset-0 w-full h-full opacity-70" />
        ...
        <div className="max-w-4xl">
          ...
          <div className="flex flex-col sm:flex-row gap-5 delay-200 opacity-0 animate-in">
            ...
            <a
              ...
              className="px-10 py-5 border border-zinc-200 dark:border-zinc-800 rounded-full font-bold text-lg hover:bg-zinc-50/80 dark:hover:bg-zinc-900/80 backdrop-blur-sm transition-all text-center"
            >
              Explore Styles
            </a>
          </div>
